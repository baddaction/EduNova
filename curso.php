...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="row">
            <div class="col-md-5">
                <img id="cursoImagen" class="img-fluid rounded shadow" src="https://via.placeholder.com/600x400"
                    alt="Imagen Curso">
            </div>
            <div class="col-md-7">
        ...
        <div id="formResenaContainer" class="card p-4 mb-4 bg-light" style="display: none;">
            <h5>Deja tu opinión</h5>
            <textarea id="txtResena" class="form-control mb-2" rows="3"
                placeholder="¿Qué te pareció el curso?"></textarea>
            <button id="btnEnviarResena" class="btn btn-primary btn-sm">Enviar Reseña</button>
        </div>
        <div id="cursoReseñas" class="row"></div>

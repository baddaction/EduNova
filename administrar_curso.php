        ...
        <div class="card p-4 mb-4 shadow-sm border-primary" style="border-left: 5px solid blue;">
            ...
            <form id="formTema">
                <div class="mb-3">
                    ...
                    <input type="text" id="tituloTema" class="form-control" placeholder="Ej: 1. Introducción..." required>
                </div>
                <div class="mb-3">
                    <label>Descripción</label>
                    <textarea id="descTema" class="form-control" rows="2" placeholder="De qué trata este tema..."></textarea>
                </div>
                <div class="mb-3">

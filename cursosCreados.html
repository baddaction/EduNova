    ...
    <nav class="bg-white border-top border-bottom">
        <div class="container">
            <ul class="nav justify-content-evenly py-2 small fw-semibold">
                ...
                <li class="nav-item"><a class="nav-link text-dark" href="#">Más Cursos</a></li>
                <li class="nav-item"><a class="nav-link text-dark" href="#">Mis Cursos Creados</a></li>
                <li class="nav-item"><a class="nav-link text-dark" href="adminCursos.html">Administrar Cursos</a></li>
            </ul>
        </div>
    </nav>

    <section class="container">
        <h2 class="text-center py-4">Mis Cursos Creados</h2>
